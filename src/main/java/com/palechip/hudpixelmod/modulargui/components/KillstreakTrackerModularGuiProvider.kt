...
object KillstreakTrackerModularGuiProvider : SimpleHudPixelModularGuiProvider(), McColorHelperJava {
    private val GREATEST_KILLSTREAK_DISPLAY_TEXT = ChatFormatting.LIGHT_PURPLE + "Best Killstreak: "
    private var currentKillstreak: Int = 0
    private var greatestKillstreak: Int = 0
    private var showGreatest: Boolean = false
    ...
    override fun onChatMessage(textMessage: String, formattedMessage: String) {
        val username = FMLClientHandler.instance().client.session.username
        // Quake
