...
object BlitzDeathmatchNotifierModularGuiProvider : SimpleHudPixelModularGuiProvider() {
    private val DISPLAY_STRING = ChatFormatting.GOLD + "DEATHMATCH STARTING SOON!"
    private val ANIMATION_TIME = 5 // in MC-Ticks
    private val DISPLAY_TIME = 140 // = 7s
    ...
    private val renderingString = DISPLAY_STRING
